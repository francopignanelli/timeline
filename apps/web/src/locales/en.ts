export const en = {
  ...
  blocks: {
    empty: 'No content yet. Add a block to start building this entry.',
    ...
    errors: {
      limitReached: 'You can add up to {{max}} blocks to a single entry.',
    },
  },

  setlist: {
    urlLabel: 'setlist.fm link',
    urlHint: 'Paste the setlist.fm page URL for this show, or its id.',
