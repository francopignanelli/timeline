...
export const es: TranslationShape = {
  ...
  blocks: {
    empty: 'Todavía no hay contenido. Agrega un bloque para empezar.',
    ...
    uploading: 'Subiendo…',
    addText: 'Agregar bloque de texto',
    ...
    errors: {
      limitReached: 'Puedes agregar hasta {{max}} bloques por entrada.',
    },
  },

  setlist: {
    urlLabel: 'Enlace de setlist.fm',
    urlHint: 'Pega la URL de la página de setlist.fm de este show, o su id.',
